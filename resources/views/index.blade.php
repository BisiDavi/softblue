  ...
  <div class="sponsorsbrand row flex-column mx-auto">
    <div class="brand-content d-flex justify-content-between w-100">
      ...
      <span class="brand-logos">
        <img src="/images/interswitch.png" alt="brand partners" />
        <img src="/images/venturegarden.png" alt="brand partners" />
        <img src="/images/upwork.png" alt="brand partners" />
      </span>
    </div>
  </div>
@endsection
      ...
      <section class="our-services container-fluid p-5">
        <div class="row py-5">
          ...
          <div class="col-lg-4 d-flex flex-column">
            ...
            <div class="col services">
              <img
                src="/images/machinelearningIcon.svg"
          ...
          <div class="col-lg-4">
            ...
            <div class="col services">
              <img src="/images/analyticsIcon.svg" alt="analytics icon" />
        ...
        <div class="row py-5">
          <div class="build-content col-lg-12">
            <div
              ...
              style="transform: translate(0px, 42.29px)"
            ></div>
            <div
              class="text-content mx-auto d-flex flex-column w-50"
              style="transform: translate(0px, 71.145px)"
            >
...
<script
  src="https://cdnjs.cloudflare.com/ajax/libs/TypewriterJS/2.17.0/core.min.js"
