            ...
            <header class="container-fluid">
              <nav class="navbar navbar-expand-lg">
                <a href="{{ url('/index.html') }}" class="navbar-brand">
                  <img
                    src="{{ asset('images/softblue_logo.png')}}"
                    class="site-logo"
                    alt="site-logo"
                  />
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                  <div id="menuNav" class="navbar-nav">
                    <a class="nav-link text-white" href="{{ url('/about.html') }}">
                      <h4>ABOUT US</h4>
                    </a>
                    <a class="nav-link text-white" href="{{ url('/services.html')}}">
                      <h4>SERVICES</h4>
                    </a>
                    <a class="nav-link text-white" href="{{ url('/contact.html')}}">
                      <h4>CONTACT</h4>
                    </a>
                  </div>
                </div>
                <span
                  onclick="showMenuLinks()"
                  id="hamburgerMenu"
